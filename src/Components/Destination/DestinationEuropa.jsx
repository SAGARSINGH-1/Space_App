    ...
    return (
        <div className='flex flex-row items-center justify-around'>
            <div className='pl-[135px] mt-[20px] w-[45%]'>
                ...
                <img className='h-[378px] w-[378px]' src="/src/imgAssests/destination/image-europa.png" alt="" />
            </div>
            ...
            <div className='w-[45%] flex justify-center items-start flex-col'>
                ...
                <h1 className='w-[100%] text-left text-white text-[95px] font-Bellefair font-normal break-words'>EUROPA</h1>
                ...
                <div className='mt-2 flex flex-row justify-between w-[50%]'>
                    <div className='flex flex-col gap-2'>
                        ...
                        <h1 className='text-white text-28 font-bellefair font-normal uppercase break-words'>628 MIL. km</h1>
                    </div>
                    <div className='flex flex-col gap-2'>
                        ...
                        <h1 className='text-white text-28 font-bellefair font-normal uppercase break-words'>3 years</h1>
                    </div>
                </div>
            </div>
        </div>  
