    ...
    return (
        <div className='flex flex-row items-center justify-around'>
            <div className='pl-[135px] mt-[20px] w-[45%]'>
                ...
                <img className='h-[378px] w-[378px]' src="/src/imgAssests/destination/image-mars.png" alt="" />
            </div>
            ...
            <div className='w-[45%] flex justify-center items-start flex-col'>
                <ul className='w-[50%] flex flex-row justify-around items-center cursor-pointer '>
                    ...
                    <NavLink to={'/destination/mars'}  className={({isActive})=>`${isActive? "pb-2 border-b-2 border-transparent border-white":"border-none"}`}>MARS</NavLink>
                    ...
                    <NavLink to={'/destination/titan'}>TITAN
                    </NavLink>
                </ul>
                <h1 className='w-[100%] text-left text-white text-[95px] font-Bellefair font-normal break-words my-[-12px]'>MARS</h1>
                ...
                <div className='border-b border-gray-400 w-[80%] mt-6'></div>
                ...
                <div className='mt-2 flex flex-row justify-between w-[50%]'>
                    <div className='flex flex-col gap-2'>
                        ...
                        <h1 className='text-white text-28 font-bellefair font-normal uppercase break-words'>225 MIL. km</h1>
                    </div>
                    <div className='flex flex-col gap-2'>
                        ...
                        <h1 className='text-white text-28 font-bellefair font-normal uppercase break-words'>9 months</h1>
                    </div>
                </div>
            </div>
        </div>  
