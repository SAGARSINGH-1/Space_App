...
export default function Crew02() {
    return (
        <div className='flex flex-row items-center justify-around h-[80vh]'>
            ...
            <h1 className='text-white text-28 font-barlow-condensed font-normal uppercase tracking-wider leading-normal break-words text-lg mb-[30px]'><NavLink to={'/crew'} className='text-gray-600 '>03</NavLink> Meet Your Crew</h1>
                <h2 className='text-gray-400 pl-[10px] mb-[4px] text-lg font-bellefair font-normal uppercase break-words'>MISSION SPECIALIST</h2>
                <h1 className='w-[100%] text-left text-white text-[55px] font-Bellefair font-normal break-words'>MARK SHUTTLEWORTH</h1>
            ...
            <div className='mt-5 mr-[100px]'>
                <img className='h-[445px] w-[448px]' src="/src/imgAssests/crew/crew02.png" alt="" />
            </div>
        </div>  
    )
}