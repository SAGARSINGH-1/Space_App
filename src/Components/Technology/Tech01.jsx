    ...
    return (
        <div className='flex flex-row items-center justify-around'>
                ...
                <div className='h-[68vh] w-[100%] flex items-center'>
                    <div className='data flex flex-row gap-12'>
                        <div className='flex flex-col gap-5'>
                            <Link to={'/technology'} className='bg-white text-black flex justify-center items-center font-semibold text-xl p-5 rounded-full w-[60px] h-[60px]'>1</Link>
                        ...
                        <div>
                            ...
                            <h1 className='text-4xl font-semibold my-2'>LAUNCH VEHICLE</h1>
            ...
            <div className='w-[45%] mt-[30px] flex justify-end items-center flex-col '>
                <img className='rounded-3xl' width={'380rem'} src="/src/imgAssests/technology/tech01.jpg" alt=""/>
            </div>
        </div>
    )
}